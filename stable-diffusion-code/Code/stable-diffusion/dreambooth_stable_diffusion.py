...
Original file is located at
    https://colab.research.google.com/drive/10Pc6Utb_1BCyCVha_1nY63EF7be8vZQZ
"""
...
OUTPUT_DIR = "stable_diffusion_weights/guhan" #@param {type:"string"}
if save_to_gdrive:
...
concepts_list = [
    {
        "instance_prompt":      "photo of guhan",
        "class_prompt":         "photo of a man",
        "instance_data_dir":    "/content/data/guhan",
...
!accelerate launch train_dreambooth.py \
  ...
  --save_interval=10000 \
  --save_sample_prompt="photo of guhan" \
...
model_id = WEIGHTS_DIR   #"runwayml/stable-diffusion-v1-5"
...
res = inference(prompt="((photo of guhan)) , man ,modelshoot style, (extremely detailed CG unity 8k wallpaper), professional majestic oil painting by Ed Blinkey, Atey Ghailan, Studio Ghibli, by Jeremy Mann, Greg Manchess, Antonio Moro, trending on ArtStation, trending on CGSociety, Intricate", negative_prompt="woman, nudes,bad art, poorly drawn, disfigured, deformed, extra limbs, ugly hands, extra fingers, canvas frame, cartoon, 3d, disfigured, bad art, deformed, extra limbs, weird colors, duplicate, morbid, mutilated, out of frame, extra fingers, mutated hands, poorly drawn hands, poorly drawn face, mutation, deformed, ugly, bad anatomy, bad proportions, extra limbs, cloned face, disfigured, out of frame, ugly, extra limbs, bad anatomy, gross proportions, malformed limbs, missing arms, missing legs, extra arms, extra legs, mutated hands, fused fingers, too many fingers, long neck, Photoshop, video game, ugly, tiling, poorly drawn hands, poorly drawn feet, poorly drawn face, out of frame, mutation, mutated, extra limbs, extra legs, extra arms, disfigured, deformed, cross-eye, body out of frame, bad art, bad anatomy, 3d render",num_samples=10)
...
def inference(prompt="((photo of guhan )),(( man )),modelshoot style, (extremely detailed CG unity 8k wallpaper), professional majestic oil painting by Ed Blinkey, Atey Ghailan, Studio Ghibli, by Jeremy Mann, Greg Manchess, Antonio Moro, trending on ArtStation, trending on CGSociety, Intricate, High Detail, Sharp focus, dramatic, photorealistic painting art by midjourney and greg rutkowski", negative_prompt="woman, nudes,B&W, logo, Watermark, bad artist, blur, blurry, text, b&w, 3d, bad art, poorly drawn, disfigured, deformed, extra limbs, ugly hands, extra fingers, canvas frame, cartoon, 3d, disfigured, bad art, deformed, extra limbs, weird colors, duplicate, morbid, mutilated, out of frame, extra fingers, mutated hands, poorly drawn hands, poorly drawn face, mutation, deformed, ugly, bad anatomy, bad proportions, extra limbs, cloned face, disfigured, out of frame, ugly, extra limbs, bad anatomy, gross proportions, malformed limbs, missing arms, missing legs, extra arms, extra legs, mutated hands, fused fingers, too many fingers, long neck, Photoshop, video game, ugly, tiling, poorly drawn hands, poorly drawn feet, poorly drawn face, out of frame, mutation, mutated, extra limbs, extra legs, extra arms, disfigured, deformed, cross-eye, body out of frame, bad art, bad anatomy, 3d render", num_samples=1, height=512, width=512, num_inference_steps=50, guidance_scale=8.5):
    with torch.autocast("cuda"), torch.inference_mode():
        return pipe(
                prompt, height=int(height), width=int(width),
                negative_prompt=negative_prompt,
...
demo = gr.Interface(
    fn=inference,
    inputs=gr.Textbox(lines=15, placeholder="Name Here..."),
    outputs="image",
)
